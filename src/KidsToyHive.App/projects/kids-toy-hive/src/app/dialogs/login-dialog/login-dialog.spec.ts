...
describe('LoginDialog', () => {
  ...
  let dialogRef: jest.Mocked<MatDialogRef<LoginDialog>>;
  ...
  beforeEach(async () => {
    ...
    dialogRef = TestBed.inject(MatDialogRef) as jest.Mocked<MatDialogRef<LoginDialog>>;
  });
  ...
  it('should call authService.tryToLogin when form is valid', () => {
    authService.tryToLogin.mockReturnValue(of({ token: 'test-token' }));
