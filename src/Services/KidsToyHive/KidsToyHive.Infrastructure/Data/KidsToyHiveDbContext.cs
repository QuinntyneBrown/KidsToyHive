...
public class KidsToyHiveDbContext : DbContext, IKidsToyHiveDbContext
{
    private readonly IMediator _mediator;
    public KidsToyHiveDbContext(DbContextOptions<KidsToyHiveDbContext> options, IMediator mediator = default)
        : base(options)
    {
        _mediator = mediator;
    }
...
public class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<KidsToyHiveDbContext>
{
    public KidsToyHiveDbContext CreateDbContext(string[] args)
    {
        IConfigurationRoot configuration = new ConfigurationBuilder()
            ...
            .Build();
        var builder = new DbContextOptionsBuilder<KidsToyHiveDbContext>();
        var connectionString = configuration["Data:DefaultConnection:ConnectionString"];
        builder.UseSqlServer(connectionString, b => b.MigrationsAssembly("KidsToyHive.Api"));
        return new KidsToyHiveDbContext(builder.Options);
    }
}
